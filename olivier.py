...
RfuBot=[lineMID]
Family=["u952fbcdd919119e46f724a47ec9b1ab1",lineMID]
admin = "u952fbcdd919119e46f724a47ec9b1ab1" 
admin=['u952fbcdd919119e46f724a47ec9b1ab1',lineMID]
...
settings = {
    ...
    "man2":"ตั้งข้อความ",
    "man3":"ตั้งข้อความ",
    "message":"บัญชีนี้ได้การป้องกันโดย ట.ப.જ.௫❹🔝۝ざูနທ้ๅՃю ระบบได้ทำการบล็อคคุณอัตโนมัติ\nติดต่อเชลบอทรึบอทวี10คอมเม้นในโพสเลยคับ",
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    line.sendMessage(to, "〘 😈TeamBoTLinE DeViL☆SELFBOT😈 〙\n""ระยะเวลาการทำงานของบอท {}".format(str(runtime)))
                elif text.lower() == 'บอท':
                    try:
                        arr = []
                        owner ="u952fbcdd919119e46f724a47ec9b1ab1"
                        creator = line.getContact(owner)
                        contact = line.getContact(lineMID)
                        grouplist = line.getGroupIdsJoined()
                        contactlist = line.getAllContactIds()
                        blockedlist = line.getBlockedContactIds()
                        ret_ = "╔══[😈TeamBoTLinE DeViL☆SELFBOT😈]" 
...
#==============================================================================#
                    ...
                    line.sendMentionFooter(to, 'เชคคท.', sender, "https://line.me/ti/p/~botline2034", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~botline2034', 'type': 'mt', 'subText': "TeamBoTLinE DeViL", 'a-installUrl': 'https://line.me/ti/p/~botline2034', 'a-installUrl': ' https://line.me/ti/p/~botline2034', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~botline2034', 'i-linkUri': 'https://line.me/ti/p/~botline2034', 'id': 'mt000000000a6b79f9', 'text': 'ARM', 'linkUri': 'https://line.me/ti/p/~botline2034'}, contentType=19)                
                    line.sendMessage(msg.to, None, contentMetadata={"STKID":"52114118","STKPKGID":"11539","STKVER":"1"}, contentType=7)
                elif text.lower() == 'ผส':
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u952fbcdd919119e46f724a47ec9b1ab1")
                elif text.lower() == 'มิด':
